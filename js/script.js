window.onload = function () {
    if(navigator.userAgent.match(/Mobile|Windows Phone|Lumia|webOS|iPhone|iPod|Blackberry|PlayBook|BB10|Opera Mini|\bCrMo\/|Opera Mobi/i)) window.location.href = "/device-not-supported/";
    //Buttons
